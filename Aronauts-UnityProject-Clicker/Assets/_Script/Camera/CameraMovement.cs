...
public class CameraMovement : MonoBehaviour
{
    ...
    ///NEW/// to connect rotation into button
    ...
    {
        targetRotation *= Quaternion.Euler(Vector3.up * direction * rotationSpeed);
    }
    ...
    ///
    /// 
    ///NEW/// to connect zoom into button
    ...
    private void AdjustZoom(int zoomDirection)
    {
        // Adjusting newZoom based on zoomDirection
